...
public class CarOwnerList {
	...
	static CarOwnerDetails p1 = new CarOwnerDetails("Abhishek", "Audi A8", 1846, 545444544, "india");
	static CarOwnerDetails p2 = new CarOwnerDetails("Deepa", "lambourghini", 7498, 55555654, "japan");
	static CarOwnerDetails p3 = new CarOwnerDetails("Rahul", "Xylo", 4596, 65654654, "india");
	...
	static int add_new_car(CarOwnerDetails obj) {
		...
		if (obj.ownerName.equalsIgnoreCase("Lena")) {
			System.out.println("Token no Leena: 3");
	...
	static void get_parked_car_location(int token) {
		if (token == 1) {
			System.out.println("Car Location : Floor 1, Section 2, Slot 15");
		}
		if (token == 2) {
			System.out.println("Car Location : Floor 2, Section 3, Slot 14");
		}
		if (token == 3) {
			System.out.println("Car Location : Floor 3, Section 1, Slot 30");
		}
